...
{
	if (mLock)
		mpPolygon[1]->Draw(XMFLOAT3(STATUS_POSITIONX + NUMSPACEX, HIDDEN_STATUS_POSITIONY + mMove, LAYER6));
	else
		mpPolygon[2]->Draw(XMFLOAT3(STATUS_POSITIONX + NUMSPACEX, HIDDEN_STATUS_POSITIONY + mMove, LAYER6));

	mpPolygon[0]->Draw(XMFLOAT3(STATUS_POSITIONX, HIDDEN_STATUS_POSITIONY - STATUS_POSITIONY + mMove, LAYER6));
}