...
{
	mpPolygon->Draw(XMFLOAT3(STATUS_POSITIONX, (float)mMove - STATUS_POSITIONY + HIDDEN_STATUS_POSITIONY, LAYER7));
	mpNumDraw->Draw(XMFLOAT3(STATUS_POSITIONX + NUMSPACEX, (float)mMove + HIDDEN_STATUS_POSITIONY, LAYER7), num);
}